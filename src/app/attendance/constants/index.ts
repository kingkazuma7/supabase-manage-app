...
export const ATTENDANCE_ERRORS = {
  ...
  /** 既に休憩中の場合のエラー */
  BREAK_ALREADY_STARTED: 'この勤務記録では既に休憩を終了しています。再度の休憩開始はできません。',
  /** 休憩開始記録がない場合のエラー */
  NO_BREAK_RECORD: '休憩が開始されていません。',
  /** 不正な休憩終了時刻の場合のエラー */
  INVALID_BREAK_END: '休憩開始時間より前の時刻に休憩終了することはできません。',
  /** 不正な休憩開始時刻の場合のエラー */
  INVALID_BREAK_START: '出勤時刻より前に休憩を開始することはできません。',
  /** 勤務中の記録が見つからない場合のエラー */
  NO_ACTIVE_WORK: '勤務中の記録が見つかりません。',
  /** 休憩状態の更新に失敗した場合のエラー */
  BREAK_UPDATE_ERROR: '休憩状態の更新に失敗しました。'
} as const;
